                ...
                aToken && (
                    <div className='py-6'>
                        ...
                        <div className='px-6 mb-10'>
                            <h2 className="text-2xl font-extrabold text-transparent cursor-pointer bg-clip-text bg-gradient-to-r from-blue-500 to-purple-600 drop-shadow-lg transform transition-transform duration-300 hover:scale-105">
                                Admin Panel
                            </h2>
